...
def Affichage_configuration(t1,t2,t3,t4,t5,T01,T12,T23,T34,T45,l1,l2,l3,l4):
    ...
    T01_eval = T01.subs([(theta1,t1),(L1,l1)])
    T12_eval = T12.subs([(theta2,t2)])
    T23_eval = T23.subs([(theta3,t3),(L2,l2)])
    T34_eval = T34.subs([(theta4,t4),(L3,l3)])
...
T01 = sp.Matrix([[sp.cos(theta1),-sp.sin(theta1),0,0],[sp.sin(theta1),sp.cos(theta1),0,0],[0,0,1,L1],[0,0,0,1]])
T12 = sp.Matrix([[1,0,0,0],[0,sp.cos(theta2),-sp.sin(theta2),0],[0,sp.sin(theta2),sp.cos(theta2),0],[0,0,0,1]])
T23 = sp.Matrix([[1,0,0,0],[0,sp.cos(theta3),-sp.sin(theta3),L2],[0,sp.sin(theta3),sp.cos(theta3),0],[0,0,0,1]])
T34 = sp.Matrix([[sp.cos(theta4),0,sp.sin(theta4),0],[0,1,0,L3],[-sp.sin(theta4),0,sp.cos(theta4),0],[0,0,0,1]])
T45 = sp.Matrix([[1,0,0,0],[0,sp.cos(theta5),-sp.sin(theta5),0],[0,sp.sin(theta5),sp.cos(theta5),0],[0,0,0,1]])
...
Affichage_configuration(0,0,0,0,0,T01,T12,T23,T34,T45,50,150,150,50)
